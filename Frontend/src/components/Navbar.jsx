  ...
  return (
    ...
    <>
      <div className="Navbar_main_fixed">
        <div className="Navbar_first">
          <div style={{ marginLeft: "0xp" }}>
            <Link to="/">
              <img
                style={{ width: "200px", height: "50px",borderRadius: "12px", objectFit:"cover" }}
        ...
        <div className="Navbar_second">
          <div className="menucontainer">
            ...
            <Link className="dropdown" to="/Haircare">
              Haircare
            </Link>
            <Link className="dropdown" to="/BathBody">
              Bath & Body
            </Link>
            <Link className="dropdown" to="/Fragarance">
              Fragarance
            </Link>
      ...
      <div id="mySidenav" className="sidenav">
        ...
        <Link className="dsropdown" to="/MakeUp">
          Makeup
        </Link>
        <Link className="dropdown" to="/Haircare">
          Haircare
