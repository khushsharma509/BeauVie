...
const bathAndBodySubTypes = [
  { id: 1, name: "Shower Gels" },
  { id: 2, name: "Roll-ons" },
  { id: 3, name: "Body scrubs" },
  { id: 4, name: "Lotions & cream" }
];
...
export default function FinalGiftingPage() {
  ...
  useEffect(() => {
    ...
    const Returnfetchuser = () => {
      return fetch(`${BASE_URL}/api/products?category=4&subcategory=${type}`)
        .then((res) => res.json());
    };
          ...
          <div>
            <div className="filter1">
              ...
              >
                ...
                >
                {bathAndBodySubTypes.find((item) => item.id === type)?.name || "All Products"}
