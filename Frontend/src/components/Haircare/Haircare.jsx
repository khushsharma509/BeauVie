...
export default function FinalBrushesPage() {
  ...
  useEffect(() => {
    ...
    const Returnfetchuser = () => {
      return fetch(`${BASE_URL}/api/products?category=3&subcategory=${type}`)
        .then((res) => res.json());
    };
          ...
          <div>
            <div className="filter1">
              ...
              >
                ...
                >
                  {makeupProdType.find((item) => item.id == type)?.name || "All Products"}
                </span>
                <span
                  style={{
                    color: "#FC2779",
